...
Com o python instalado, basta acessar o dirétorio do arquivo pelo terminal e digitar 'python Org_and_run_CAJOlang.py' (Windows)
																				ou 	 'python3 Org_and_run_CAJOlang.py' (Linux)
